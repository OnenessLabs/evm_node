...
type Beacon struct {
	ethone consensus.ConsensusEngine // Original consensus engine used in eth1, e.g. ethash or clique
}

// New creates a consensus engine with the given embedded eth1 engine.
func New(ethone consensus.ConsensusEngine) *Beacon {
...
// Author implements consensus.ConsensusEngine, returning the verified author of the block.
...
// Prepare implements consensus.ConsensusEngine, initializing the difficulty field of a
...
// Finalize implements consensus.ConsensusEngine, setting the final state on the header
...
// FinalizeAndAssemble implements consensus.ConsensusEngine, setting the final state and
...
// APIs implements consensus.ConsensusEngine, returning the user facing RPC APIs.
...
func (beacon *Beacon) InnerEngine() consensus.ConsensusEngine {
