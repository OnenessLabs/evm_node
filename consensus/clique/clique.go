...
func (c *Clique) Finalize(chainchain consensus.ChainHeaderReader, header *types.Header, state *state.StateDB, txs *[]*types.Transaction,
...
func (c *Clique) FinalizeAndAssemble(chain consensus.ChainHeaderReader, header *types.Header, state *state.StateDB, txs []*types.Transaction,
	...
	// Finalize block
	c.Finalize(chain, header, state, &txs, uncles, &receipts, nil, withdrawals, nil)
